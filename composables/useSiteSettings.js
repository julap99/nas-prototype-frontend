export const useSiteSettings = () => {
  ...
  // Load site settings from API (now using mock data)
  ...
  // Update site settings (now using mock data - always returns success)
  const updateSiteSettings = async (newSettings) => {
    console.log("[useSiteSettings] updateSiteSettings called with:", JSON.parse(JSON.stringify(newSettings)));
    try {
      // Mock update - in real implementation, this would call external API
  ...
  // Add custom theme to theme.css file (now mock)
  const addCustomThemeToFile = async (themeName, themeCSS) => {
    try {
      // Mock theme addition - in real implementation, this would call external API
