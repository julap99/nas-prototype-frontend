...
export const ekpApi = {
  ...
  getApplication: (id: number): Promise<any> =>
    apiRequest(`/ekp/applications/${id}`),
  createApplication: (data: any): Promise<any> =>
    apiRequest("/ekp/applications", { method: "POST", body: data }),
  updateApplication: (id: number, data: any): Promise<any> =>
    apiRequest(`/ekp/applications/${id}`, { method: "PUT", body: data }),
  deleteApplication: (id: number): Promise<any> =>
    apiRequest(`/ekp/applications/${id}`, { method: "DELETE" }),
...
export const pkpApi = {
  ...
  getApplication: (id: number): Promise<any> =>
    apiRequest(`/pkp/applications/${id}`),
  createApplication: (data: any): Promise<any> =>
    apiRequest("/pkp/applications", { method: "POST", body: data }),
  updateApplication: (id: number, data: any): Promise<any> =>
    apiRequest(`/pkp/applications/${id}`, { method: "PUT", body: data }),
  deleteApplication: (id: number): Promise<any> =>
    apiRequest(`/pkp/applications/${id}`, { method: "DELETE" }),
...
export const eoadApi = {
  ...
  getApplication: (id: number): Promise<any> =>
    apiRequest(`/eoad/applications/${id}`),
  createApplication: (data: any): Promise<any> =>
    apiRequest("/eoad/applications", { method: "POST", body: data }),
  updateApplication: (id: number, data: any): Promise<any> =>
    apiRequest(`/eoad/applications/${id}`, { method: "PUT", body: data }),
  deleteApplication: (id: number): Promise<any> =>
    apiRequest(`/eoad/applications/${id}`, { method: "DELETE" }),
...
export const asnafApi = {
  ...
  getApplication: (id: number): Promise<any> =>
    apiRequest(`/asnaf/applications/${id}`),
  submitApplication: (data: any): Promise<any> =>
    apiRequest("/asnaf/applications", { method: "POST", body: data }),
  updateApplication: (id: number, data: any): Promise<any> =>
    apiRequest(`/asnaf/applications/${id}`, { method: "PUT", body: data }),
  getMyDocuments: (): Promise<any[]> => apiRequest("/asnaf/documents"),
  getApplicationStatus: (id: number): Promise<any> =>
    apiRequest(`/asnaf/applications/${id}/status`),
};
...
export const adminApi = {
  ...
  getAuditLogs: (query?: {
    ...
    startDate?: string;
    endDate?: string;
  }): Promise<any> => apiRequest("/admin/logs", { query }),
  ...
  getUserActivity: (query?: {
    ...
    startDate?: string;
    endDate?: string;
  }): Promise<any[]> => apiRequest("/admin/reports/user-activity", { query }),
};
